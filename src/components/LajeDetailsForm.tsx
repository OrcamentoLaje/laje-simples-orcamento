              ...
              <div className="space-y-6 bg-gray-50 p-4 rounded-lg">
                <div>
                  ...
                  <Select value={tipoTela} onValueChange={setTipoTela}>
                    ...
                    <SelectContent>
                      <SelectItem value="Tela Q45 20x20 3.4(2x3)">Tela Q45 20x20 3.4(2x3)</SelectItem>
                      <SelectItem value="Tela Q61 15x15 3.4(2x3)">Tela Q61 15x15 3.4(2x3)</SelectItem>
                      <SelectItem value="Tela Q69 20x20 4.2(2x3)">Tela Q69 20x20 4.2(2x3)</SelectItem>
                      <SelectItem value="Tela Q92 15x15 4.2(2x3)">Tela Q92 15x15 4.2(2x3)</SelectItem>
                      <SelectItem value="Tela Q138 10x10 4.2(2x3)">Tela Q138 10x10 4.2(2x3)</SelectItem>
                      <SelectItem value="Tela Q196 10x10 5.0(2x3)">Tela Q196 10x10 5.0(2x3)</SelectItem>
                      <SelectItem value="Tela Q61 15x15 3.4(2,45x6)">Tela Q61 15x15 3.4(2,45x6)</SelectItem>
                      <SelectItem value="Tela Q92 15x15 4.2(2,45x6)">Tela Q92 15x15 4.2(2,45x6)</SelectItem>
                      <SelectItem value="Tela Q138 10x10 4.2(2,45x6)">Tela Q138 10x10 4.2(2,45x6)</SelectItem>
                      <SelectItem value="Tela Q196 10x10 5.0(2,45x6)">Tela Q196 10x10 5.0(2,45x6)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
